...
<%--Girish --%>
    ...
    <b>Email</b> : <br/>
<dsp:input type="text" bean="${formHandlerComponent}.email" maxlength="30" iclass="required"
                 id="atg_store_localityInput" required="${requiredTrueText}" value=""/>
</li>
    ...
    <li>
      ...
      <c:choose>
        <c:when test="${empty preFillValues || preFillValues}">
          <br/><dsp:select iclass="custom_select" id="atg_store_stateSelect" bean="${formHandlerComponent}.state">
            <%@include file="/global/util/countryStatePicker.jspf" %>
          </dsp:select>
        </c:when>
        <c:otherwise>
          <br/><dsp:select iclass="custom_select" id="atg_store_stateSelect" bean="${formHandlerComponent}.state" nodefault="true">
            <%@include file="/global/util/countryStatePicker.jspf" %>
          </dsp:select>
        </c:otherwise>
      </c:choose>
