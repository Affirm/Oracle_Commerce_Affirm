...
<c:if test="${showAffirmPaymentOption}">
	<p><b>Choose Payment Type</b>: <input type="radio" name="paymentType" onclick="paymentTypeClicked(this)" id="creditcard" checked="true"> Credit Card
	&nbsp;&nbsp;

	<!--Check the logic if affirm applies, then only show radio buttons -->
	<input type="radio" name="paymentType" onclick="paymentTypeClicked(this)" id="affirm"> <img vertical-align="middle" src="http://cdn-assets.affirm.com/images/blue_logo-transparent_bg.png" width="74"/> Monthly Payments <a href="#" class="affirm-product-modal" data-promo-id="${dataPromoId}" data-amount="${dataAmount}">Learn more</a>
	<br/><br/>
