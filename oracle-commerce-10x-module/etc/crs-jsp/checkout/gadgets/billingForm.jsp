...
<dsp:importbean var="affirmConfig" bean="/affirm/commerce/payment/AffirmPaymentConfiguration" />
  ...
  <%@ include file="/global/affirm-js.jsp" %>
      ...
      <c:if test="${not empty permittedAddresses}">
        <div id="atg_store_selectAddress">
          ...
          <fieldset class="atg_store_billingAddresses">
            ...
            <%-- Continue button --%>
<div id="creditCardPayWithSavedAddress">            
...
<div id="affirmPayWithSavedAddress" style="display:none">
 <div class="atg_store_saveSelectAddress atg_store_formActions">
              <span class="atg_store_basicButton">
                
                <fmt:message var="continueButtonText" key="common.button.continueText"/>
                
                <dsp:input type="submit" bean="AffirmBillingFormHandler.affirmPaymentWithSavedAddress" 
                           value="${continueButtonText}" alt="${continueButtonText}" id="submit" 
                           iclass="atg_store_actionSubmit atg_behavior_disableOnClick"/>
              </span>
              <p>
                <fmt:message key="checkout_billing.usingSavedAddress"/> Affirm
              </p>
...
<c:if test="${showAffirmPaymentOption}">
	<div id="affirmSection" style="display:none">

		<p>Affirm New Billing Addres


		<fieldset class="atg_store_newBillingAddress">
		  <dsp:include page="billingAddressAffirmAdd.jsp"/>
		</fieldset>
       ...
       <%-- Continue with new address button. --%>
        <div class="atg_store_saveNewBillingAddress atg_store_formActions">
          <span class="atg_store_basicButton">
            ...
            <dsp:input type="submit" bean="AffirmBillingFormHandler.affirmPaymentWithNewAddress" 
                       value="${reviewOrderButtonText}" alt="${reviewOrderButtonText}" id="submit" 
                       iclass="atg_store_actionSubmit atg_behavior_disableOnClick"/>
          </span>
          <p>
            <fmt:message key="checkout_billing.usingNewAddress"/> Affirm
          </p>
	</div>
    ...
    <fieldset class="atg_store_checkoutContinue">
      <div class="atg_store_formFooter">
        ...
        <dsp:input type="hidden" bean="AffirmBillingFormHandler.moveToConfirmSuccessURL" 
                   value="confirm.jsp"/>
        <dsp:input type="hidden" bean="AffirmBillingFormHandler.moveToConfirmErrorURL" 
                   value="billing.jsp?preFillValues=true"/>
